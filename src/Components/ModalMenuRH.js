...
return (
  <>
    ...
    <Modal show={show} onHide={handleClose}>
      ...
      <Modal.Body><Link style={{textDecoration:"none"}}  to="/solicitations">Solicitações</Link></Modal.Body>
      <Modal.Body><Link style={{textDecoration:"none"}} to="/report">Relatórios</Link></Modal.Body>
      <Modal.Footer>
      </Modal.Footer>
    </Modal>
  </>
